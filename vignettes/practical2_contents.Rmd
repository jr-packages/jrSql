...
To being with we will grab the flights data that we were using in the final part of the lectures. You can install the package that contains this data with 
...
(1) There are lots of interesting things that you can do with these 5 tables. Try to find something interesting about the flights data, maybe even produce a nice graphic. There will be a prize for whoever can come up with the most interesting (as decided by you).
